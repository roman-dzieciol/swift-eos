...
public class SwiftEOS_Connect_Actor: SwiftEOSActor {
    ...
    */
    ...
    /**
    Retrieve the equivalent external account mappings from a list of Product User IDs.This will include data for each external account info found for the linked product IDs.
    ...
    */
    ...
    - Parameter LocalDeviceUserId: The product user id, currently logged in, that has been originally created using the anonymous local Device ID login type,and whose Device ID login will be transferred to the keychain of the PrimaryLocalUserId.
    ...
    */
    ...
    - Parameter LocalUserId: Existing logged in product user that is subject for the unlinking operation.The external account that was used to login to the product user will be unlinked from the owning keychain.
