...
public struct SwiftEOS_Connect_UserLoginInfo: SwiftEOSObject {
    ...
    */
    ...
    - Parameter DisplayName: The user's display name on the identity provider systems as UTF-8 encoded null-terminated string.The length of the name can be at maximum up to EOS_CONNECT_USERLOGININFO_DISPLAYNAME_MAX_LENGTH bytes.
    */
    public init(
