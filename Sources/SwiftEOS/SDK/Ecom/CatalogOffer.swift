...
public struct SwiftEOS_Ecom_CatalogOffer: SwiftEOSObject {
    ...
    */
    ...
    public init?(
        ...
        self.TechnicalDetailsText_DEPRECATED = stringFromOptionalCStringPointer(sdkObject.TechnicalDetailsText_DEPRECATED)
        self.CurrencyCode = stringFromOptionalCStringPointer(sdkObject.CurrencyCode)
