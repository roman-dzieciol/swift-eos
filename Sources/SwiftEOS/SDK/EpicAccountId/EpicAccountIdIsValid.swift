...
/**
Check whether or not the given Epic Online Services Account ID is considered valid NOTE: This will return true for any EOS_EpicAccountId created with EOS_EpicAccountId_FromString as there is no validation
