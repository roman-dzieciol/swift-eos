...
public class SwiftEOS_KWS_Actor: SwiftEOSActor {
    ...
    */
    ...
    - Returns: EOS_Success if account creation completes successfully EOS_InvalidParameters if any of the options are incorrect EOS_TooManyRequests if the number of allowed requests is exceeded
    */
    ...
    */
    ...
    - Parameter CompletionDelegate: A callback that is fired when the operation completes, either successfully or in error
    - Returns: EOS_Success if the query completes successfully EOS_InvalidParameters if any of the options are incorrect EOS_TooManyRequests if the number of allowed queries is exceeded
    */
    ...
    - Parameter CompletionDelegate: A callback that is fired when the operation completes, either successfully or in error
    - Returns: EOS_Success if the account query completes successfully EOS_InvalidParameters if any of the options are incorrect EOS_TooManyRequests if the number of allowed requests is exceeded
    */
    ...
    - Parameter CompletionDelegate: A callback that is fired when the operation completes, either successfully or in error
    - Returns: EOS_Success if contact information update completes successfully EOS_InvalidParameters if any of the options are incorrect EOS_TooManyRequests if the number of allowed requests is exceeded EOS_KWS_ParentEmailMissing if the account requesting permissions has no parent email associated with it EOS_LimitExceeded if the number of permissions exceeds EOS_KWS_MAX_PERMISSIONS, or if any permission name exceeds EOS_KWS_MAX_PERMISSION_LENGTH
    */
    ...
    - Parameter CompletionDelegate: A callback that is fired when the operation completes, either successfully or in error
    - Returns: EOS_Success if contact information update completes successfully EOS_InvalidParameters if any of the options are incorrect EOS_TooManyRequests if the number of allowed requests is exceeded
    */
