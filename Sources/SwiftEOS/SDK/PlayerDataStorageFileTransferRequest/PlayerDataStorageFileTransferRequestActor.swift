...
public final class SwiftEOS_PlayerDataStorageFileTransferRequest_Actor: SwiftEOSActor {
    ...
    */
    ...
    - Throws: EOS_PlayerDataStorage_RequestInProgress` if the request is still in progress, or another state for failure.
    */
    ...
    - Throws: - SeeAlso: `EOS_PLAYERDATASTORAGE_FILENAME_MAX_LENGTH_BYTES`
