...
public final class SwiftEOS_Friends_RejectInviteTests: XCTestCase {
    public func testEOS_Friends_RejectInvite_Null() throws {
        try autoreleasepool { 
            ...
            __on_EOS_Friends_RejectInvite = { Handle, Options, ClientData, CompletionDelegate in
                ...
                CompletionDelegate?(GTest.current.pointer(object: _tagEOS_Friends_RejectInviteCallbackInfo(
                            ResultCode: .zero,
