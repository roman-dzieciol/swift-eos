...
public class SwiftEOS_Platform_GetSessionsInterfaceTests: XCTestCase {
    public func testEOS_Platform_GetSessionsInterface_Null() throws {
        try autoreleasepool { 
            ...
            // Then
            XCTAssertEqual(TestGlobals.current.sdkReceived, ["EOS_Platform_GetSessionsInterface"])
            XCTAssertNil(result)
        }
        
        // Then
        __on_EOS_Platform_Release = nil
        XCTAssertEqual(TestGlobals.current.sdkReceived, ["EOS_Platform_GetSessionsInterface", "EOS_Platform_Release"])
    }
}
