...
public final class SwiftEOS_SessionSearch_SetMaxResultsTests: XCTestCase {
    public func testEOS_SessionSearch_SetMaxResults_Null() throws {
        try autoreleasepool { 
            ...
            // Then
            XCTAssertEqual(GTest.current.sdkReceived, ["EOS_SessionSearch_SetMaxResults"])
        }
        
        // Then
        __on_EOS_SessionSearch_Release = nil
        XCTAssertEqual(GTest.current.sdkReceived, ["EOS_SessionSearch_SetMaxResults", "EOS_SessionSearch_Release"])
    }
}
